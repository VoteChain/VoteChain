...
class UserProfile {
  ...
  constructor(walletId, name, about = "", email = "", dateJoined = blockTimestamp().toString()) {
   ...
   */
  updateProfile(name = this.name, about = this.about, email = this.email) {
    this.name = name;
    this.about = about;
    this.email = email;
  }
...
class UserManager {
  ...
  // Add a new user
  addUser(walletId, name, about, email) {
  ...
  updateUser(walletId, name, about, email) {
...
let VoteChain = (_dec = NearBindgen({}), _dec2 = view(), _dec3 = call({}), _dec4 = call({}), _dec(_class = (_class2 = class VoteChain {
  ...
  // ====================
  // User profiles
  userProfiles = new UnorderedMap("user_profiles");
...
}, _applyDecoratedDescriptor(_class2.prototype, "get_user", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "get_user"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "add_user", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "add_user"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "update_user", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "update_user"), _class2.prototype), _class2)) || _class);
function update_user() {
  const _state = VoteChain._getState();
  if (!_state && VoteChain._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  const _contract = VoteChain._create();
  if (_state) {
    VoteChain._reconstruct(_contract, _state);
  }
  const _args = VoteChain._getArgs();
  const _result = _contract.update_user(_args);
  VoteChain._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(VoteChain._serialize(_result, true));
}
function add_user() {
  const _state = VoteChain._getState();
  if (!_state && VoteChain._requireInit()) {
...
export { add_user, get_user, update_user };
//# sourceMappingURL=vote_chain.js.map

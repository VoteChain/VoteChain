        ...
        <section className="features-section">
          ...
          <div className="features-grid">
            <div className="feature-card">
              ...
              <h3>Secure Voting</h3>
              <p>
                Blockchain technology ensures votes are immutable and
                verifiable, preventing tampering and fraud.
              </p>
            </div>
            <div className="feature-card">
              <div className="feature-icon">
            ...
            <div className="feature-card">
              ...
              <p>
                Support for multiple voting methods: ranked choice, quadratic,
                and token-weighted.
              </p>
            </div>
            <div className="feature-card">
